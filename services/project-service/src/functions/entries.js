  ...
  async entry(email, text) {
    try {
      ...
      const commentInstruction = calculatedDate
        ? `Write a warm, human comment (1-2 sentences) DIRECTLY TO the user. Talk TO them, not ABOUT them. NEVER say "The user" or "The user wants to" — that sounds robotic. Be casual and direct, like texting a friend.\n- CORRECT: "Skydiving and cooking lessons — both sorted! Created new projects for each since they didn't fit anywhere existing."\n- WRONG: "The user wants to engage in two distinct activities: skydiving and cooking lessons. I created new projects for each activity since they didn't clearly fit into the existing projects." ← robotic, third-person\n- CORRECT: "Added to WebApp — looks like a solid bug fix."\n- WRONG: "The user mentioned a bug fix so I added it to the WebApp project." ← third-person meta-commentary\nIf matched=1, say something like "Added to [project] — [warm comment]." If matched=0, say something like "Created [project] and added your first entry — [warm comment]." If matched=2, say something like "Created [project] for you — [warm comment]." If matched=3, briefly list what was added in a natural way.`
        : `Write a warm, human comment (2-3 sentences) DIRECTLY TO the user. Talk TO them, not ABOUT them. NEVER say "The user" or "The user wants to" — that sounds robotic. Be casual and direct, like texting a friend. Let them know no due date was set because no date reference was found. Suggest they can edit the entry later to add one.\n- CORRECT: "Added to WebApp — nice bug fix! Didn't catch a due date in there though, so it's blank for now. You can always edit it later."\n- WRONG: "The user wants to fix a bug in WebApp. I added the entry but no due date was set because no date reference was found in their text." ← robotic, third-person\nIf matched=1, say something like "Added to [project] — [warm comment]. No due date picked up, feel free to edit." If matched=0, say something like "Created [project] — [warm comment]. No due date set, you can add one later." If matched=2, say something like "Created [project] for you — [warm comment]." If matched=3, briefly list what was added and mention no due date was set.`;
