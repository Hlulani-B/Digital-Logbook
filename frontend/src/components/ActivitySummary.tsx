...
export function ActivitySummary() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        if (!cancelled) {
          setSummary(aiResult.success && aiResult.response ? aiResult.response : "Here's what you've been up to recently.");
        }
      } catch (err) {
  ...
  if (loading) {
    return (
      <div className="activity-summary ai-greeting animate-in">
