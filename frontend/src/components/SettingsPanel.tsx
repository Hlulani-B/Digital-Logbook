...
function ResetPasswordInline({
  ...
  if (sent) {
    return (
      ...
      >
        A password reset link has been sent to <strong>{email}</strong>. Check your inbox (and spam
  ...
  return (
    <>
      ...
      <button onClick={handleSend} disabled={sending || !email} className="btn-secondary">
    ...
    <>
      ...
      <div className="panel-sheet">
        ...
        <div className="panel-header">
          <h2>
            {tab === 'profile' ? 'Manage Profile' : tab === 'preferences' ? 'Settings' : 'Account'}
          </h2>
            ...
            <>
              <div className="panel-section">
                ...
                <div className="field-group">
                  ...
                  <p className="field-hint">Where you land after signing in.</p>
                </div>
                ...
                <div className="field-group">
                  ...
                  <select
                    ...
                    onChange={(e) => setPrefs((p) => ({ ...p, weekStartsOn: e.target.value }))}
                  >
                ...
                <div className="field-group">
                  ...
                  <p className="field-hint">Change the typography across the entire logbook.</p>
                </div>
              ...
              <div className="panel-section">
                ...
                <div className="field-group">
                  ...
                  <p className="field-hint">
                    {prefs.tone === 'soft' &&
                      'Warm, gentle, and encouraging. Like a caring friend.'}
                    {prefs.tone === 'tough' && 'Direct and no-nonsense. Pushes you to be better.'}
                    {prefs.tone === 'cynical' &&
                      'Witty and slightly sarcastic. Roasts you but has your back.'}
                  </p>
                </div>
              </div>
              ...
              <div className="panel-section">
                ...
                <div className="toggle-row">
                  <div className="toggle-info">
                    ...
                    <p className="toggle-desc">Automatically save drafts as you type.</p>
                  </div>
                ...
                <div className="toggle-row">
                  <div className="toggle-info">
                    ...
                    <p className="toggle-desc">Tighter spacing to see more entries at once.</p>
                  </div>
                  <label className="toggle-switch">
                    <input
                      type="checkbox"
              ...
              <div className="panel-section">
                ...
                <div className="toggle-row">
                  <div className="toggle-info">
                    ...
                    <p className="toggle-desc">Receive updates about your account.</p>
                  </div>
                  <label className="toggle-switch">
                    <input
                      type="checkbox"
                ...
                <div className="toggle-row">
                  <div className="toggle-info">
                    ...
                    <p className="toggle-desc">Get a nudge to log your hours each Friday.</p>
                  </div>
                  <label className="toggle-switch">
                    <input
                      type="checkbox"
                  ...
                  <>
                    {!showDeleteConfirm ? (
                      ...
                      <div className="confirm-box">
                        {deleteError && <p style={{ marginBottom: '0.75rem' }}>{deleteError}</p>}
                        <p>
                          Are you sure? Your account will enter a 30-day grace period before being
                          permanently deleted.
                        </p>
