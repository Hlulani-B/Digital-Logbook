    ...
    <div className="dash-layout">
      ...
      <aside className={`drawer ${drawerOpen ? 'drawer-open' : ''}`}>
        ...
        <div className="drawer-section">
          ...
          <button
            className={`drawer-item ${isActive('/dashboard') || isActive('/dashboard/all') ? 'active' : ''}`}
            onClick={() => {
              navigate('/dashboard');
              setDrawerOpen(false);
            }}
          ...
          <button
            className={`drawer-item ${isActive('/entries') ? 'active' : ''}`}
            onClick={() => {
              navigate('/entries');
              setDrawerOpen(false);
            }}
          ...
          <button
            className={`drawer-item ${isActive('/streaks') ? 'active' : ''}`}
            onClick={() => {
              navigate('/streaks');
              setDrawerOpen(false);
            }}
